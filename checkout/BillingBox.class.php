...
class TCPBillingBox extends TCPCheckoutBox {
	...
	function showRegion( $id, $field ) {
		...
		$regions = apply_filters( 'tcp_load_regions_for_billing', false );
		?>
		...
		<input type="text" id="billing_region" name="billing_region" value="<?php echo $region; ?>" size="20" maxlength="255" <?php if ( is_array( $regions ) && count( $regions ) > 0 ) echo 'style="display:none;"';?> class="form-control" />
