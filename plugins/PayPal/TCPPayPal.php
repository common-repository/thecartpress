...
//$headers .= "From: Tests <testing@pluginsmaker.com>\r\n";
//wp_mail( '????', 'tcp_paypal_ipn', print_r( $_REQUEST, true ) , $headers );
...
//$headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
//$headers .= "From: Tests <testing@pluginsmaker.com>\r\n";
//wp_mail( '?????', 'tcp_paypal_ipn', sprintf( __( 'Amount or curreny are not equal: %s = %s, %s = %s', tcp ), $amount, $_POST['mc_gross'], $currency, $_POST['mc_currency'] ), $headers );
