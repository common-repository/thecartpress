...
jQuery( function() {
	...
	// TheCartPress tabs (using wordpress tabs but show/hide panels instead of use URLs)
	...
	// Data picker
	jQuery( '.tcp-date-picker' ).datepicker( {
		dateFormat	: 'yy-mm-dd',
		showOn		: 'both',
	...
	// Data-time picker
	/*jQuery( '.tcp-date-time-picker' ).datepicker( {
		dateFormat	: 'yy-mm-dd h:i',
		showOn		: 'both',
		buttonText	: '<i class="dashicons dashicons-calendar-alt"></i>',
	} );*/

	// Set select2 behaviour to all object with class 'tcp-select2'
	jQuery( '.tcp-select2' ).select2( {
		width	: 'element',
	} );
} );
