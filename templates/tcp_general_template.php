...
<div id="tcp_login">
	<form id="<?php echo $args['form_id']; ?>" method="post" action="<?php echo $url; ?>" name="<?php echo $args['form_id']; ?>">
		...
		<div class="form-group tcp_login_submit">
			<button id="<?php echo esc_attr( $args['id_submit'] ); ?>" class="tcp_checkout_button tcp-btn <?php tcp_the_buy_button_color(); ?>" type="submit" value="" name="tcp_submit"><?php echo esc_html( $args['label_log_in'] ); ?></button>
			<?php $redirect = isset( $args['redirect'] ) ? $args['redirect'] : '';
		...
		<div class="form-group tcp_lost_password">
			<a id="tcp_lost_password" href="<?php echo wp_lostpassword_url( $args['redirect'] ); ?>" title="<?php _e( 'Password Lost and Found' ) ?>"><?php _e( 'Lost your password?' ); ?></a>
				...
				<a href="<?php echo $register_link ?>" id="tcp_link_register" class="tcp-btn <?php tcp_the_buy_button_color(); ?>"><?php _e( 'Register' ); ?></a>
				<?php }
...
<div id="password-reset-form" class="widecolumn">
    ...
    <form name="resetpassform" id="resetpassform" action="" method="post" autocomplete="off">
		...
		<p class="resetpass-submit">
			<button type="submit" name="action" value="tcp-reset-pass" id="resetpass-button" class="button btn tcp-btn <?php tcp_the_buy_button_color(); ?>"><?php _e( 'Reset Password', 'tcp' ); ?></button>
		</p>
	</form>
</div>
<?php endif; ?>
...
//		'redirect'		=> 'http://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'],
	...
	<form action="<?php echo $url ?>" method="post" role="form" class="form-horizontal tcp_register">
		...
		<p>
			<button type="submit" name="tcp_register_action" id="tcp_register_action" class="tcp_checkout_button tcp-btn <?php tcp_the_buy_button_color(); ?>"><?php _e( 'Register', 'tcp' ); ?></button>
		</p>
