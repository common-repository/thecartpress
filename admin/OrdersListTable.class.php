...
require_once( TCP_ADMIN_FOLDER . 'ListTable.class.php' );

class TCPOrdersListTable extends TCP_List_Table {
	...
	function get_column_info() {
		...
		return array( $orders_columns , array(), array(), $this->get_primary_column_name() );
	}
