...
if ( !class_exists( 'ShoppingCartSummaryWidget' ) ) :
...
class ShoppingCartSummaryWidget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'shoppingcartsummary-widget', 'TCP Shopping Cart Summary', $widget, $control );
	}

	function widget( $args, $instance ) {
		$shoppingCart = TheCartPress::getShoppingCart();
		$hide_if_empty = isset( $instance['hide_if_empty'] ) ? $instance['hide_if_empty'] : false;
		if ( $hide_if_empty && $shoppingCart->isEmpty() ) {
			return;
		}
		extract( $args );
	...
	function form( $instance ) {
		...
		$hide_if_empt		= isset( $instance['hide_if_empty'] ) ? (bool)$instance['hide_if_empty'] : false;
		$see_product_coun	= isset( $instance['see_product_count'] ) ? (bool)$instance['see_product_count'] : false;
		$see_weigh			= isset( $instance['see_weight'] ) ? (bool)$instance['see_weight'] : false;
		...
		$instanc			= wp_parse_args( (array)$instance, $defaults ); ?>
		<p>
