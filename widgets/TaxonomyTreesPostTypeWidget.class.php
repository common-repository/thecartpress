...
class TaxonomyTreesPostTypeWidget extends TCPParentWidget {
	...
	function wp_head() {
		...
		if ( isset( $term_id ) ) {
			setcookie( 'thecartpress_last_taxonomy', $term_id, time() + 1209600, COOKIEPATH, COOKIE_DOMAIN, false );
		}
	}
