...
$see_product_thumbnail = $thecartpress->get_setting( 'see_product_thumbnail' . $suffix, 'tcp-none' );
if ( $see_product_thumbnail == 'tcp-none' ) {
	$see_product_thumbnail = $thecartpress->get_setting( 'see_product_thumbnail', 'true' );
}
...
<div class="row">
	...
	<?php else : ?>
	<div class="single-product-options col-md-12">
	<?php endif; ?>
