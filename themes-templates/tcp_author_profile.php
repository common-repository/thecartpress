	...
	<div class="media">
		...
		<div class="media-body">
			...
			<ul class="tcp-profile-group">
				...
				if ( !empty( $wpmu_version ) || $current_user->user_level > 8 ) : ?>
				...
				<li class="tcp-new-password">
					<a id="wp-new-password" href="<?php echo add_query_arg( 'action', 'retrievepassword', wp_lostpassword_url() ); ?>"><span class="glyphicon glyphicon-edit"></span> <?php _e( 'Change Password', 'tcp' ); ?></a>
				</li>
