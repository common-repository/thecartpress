...
class TCPCurrencyCountrySettings {
	...
	function tcp_admin_menu() {
		if ( ! current_user_can( 'tcp_edit_settings' ) ) {
			return;
		}
		global $thecartpress;
...
<tr valign="top">
	...
	<td>
		<select id="currency" name="currency" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		...
		<select id="tcp_custom_layouts" onchange="jQuery('#currency_layout').val(jQuery('#tcp_custom_layouts').val());" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		<select id="unit_weight" name="unit_weight" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		<label><?php _e( 'Default format', 'tcp' ); ?>: <select id="date_format_predesign" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		<select id="country" name="country" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		...
		<div class="sel_billing_isos" <?php if ( count( $billing_isos ) == 0 ) echo 'style="display:none;"'; ?> >
			<select id="billing_isos" name="billing_isos[]" style="height:auto" size="8" multiple class="tcp-select2">
			<?php $countries = TCPCountries::getAll();
			foreach( $countries as $item ) :?>
