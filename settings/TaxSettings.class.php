...
<tr valign="top">
	...
	<td>
		...
		<select id="default_tax_country" name="default_tax_country" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		<select id="tax_based_on" name="tax_based_on" class="tcp-select2">
...
<tr valign="top">
	...
	<td>
		<select id="tax_for_shipping" name="tax_for_shipping" class="tcp-select2">
